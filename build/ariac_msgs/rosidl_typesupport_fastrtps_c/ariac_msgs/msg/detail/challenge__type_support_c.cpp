...
#include "ariac_msgs/msg/detail/human_challenge__functions.h"  // human_challenge
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: human_challenge
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, ariac_msgs, msg, HumanChallenge
      )()->data);
    if (!callbacks->cdr_serialize(
        &ros_message->human_challenge, cdr))
    {
      return false;
    }
  }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: human_challenge
  {
    ...
    if (!callbacks->cdr_deserialize(
        cdr, &ros_message->human_challenge))
    {
      return false;
    }
  }
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_ariac_msgs__msg__HumanChallenge(
    &(ros_message->human_challenge), current_alignment);
  ...
  size_t current_alignment)
{
  ...
  // member: human_challenge
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_ariac_msgs__msg__HumanChallenge(
        full_bounded, current_alignment);
    }
  }
