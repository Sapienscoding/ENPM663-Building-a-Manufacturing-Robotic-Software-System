...
#include "ariac_msgs/msg/detail/assembly_state__rosidl_typesupport_fastrtps_c.h"
...
using _AssemblyState__ros_msg_type = ariac_msgs__msg__AssemblyState;
  ...
  void * untyped_ros_message)
{
  ...
  _AssemblyState__ros_msg_type * ros_message = static_cast<_AssemblyState__ros_msg_type *>(untyped_ros_message);
  // Field name: battery_attached
  {
    uint8_t tmp;
    cdr >> tmp;
...
size_t get_serialized_size_ariac_msgs__msg__AssemblyState(
  const void * untyped_ros_message,
...
static uint32_t _AssemblyState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ariac_msgs__msg__AssemblyState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ariac_msgs
size_t max_serialized_size_ariac_msgs__msg__AssemblyState(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
static size_t _AssemblyState__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_ariac_msgs__msg__AssemblyState(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ariac_msgs, msg, AssemblyState)() {
