...
ariac_msgs__msg__Challenge__init(ariac_msgs__msg__Challenge * msg)
{
  ...
  // human_challenge
  if (!ariac_msgs__msg__HumanChallenge__init(&msg->human_challenge)) {
    ariac_msgs__msg__Challenge__fini(msg);
    return false;
  }
  return true;
...
ariac_msgs__msg__Challenge__fini(ariac_msgs__msg__Challenge * msg)
{
  ...
  // human_challenge
  ariac_msgs__msg__HumanChallenge__fini(&msg->human_challenge);
}
...
ariac_msgs__msg__Challenge__are_equal(const ariac_msgs__msg__Challenge * lhs, const ariac_msgs__msg__Challenge * rhs)
{
  ...
  // human_challenge
  if (!ariac_msgs__msg__HumanChallenge__are_equal(
      &(lhs->human_challenge), &(rhs->human_challenge)))
  {
    return false;
  }
  return true;
  ...
  ariac_msgs__msg__Challenge * output)
{
  ...
  if (!ariac_msgs__msg__HumanChallenge__copy(
      &(input->human_challenge), &(output->human_challenge)))
  {
    return false;
  }
  return true;
