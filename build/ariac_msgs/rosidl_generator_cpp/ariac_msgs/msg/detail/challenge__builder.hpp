...
class Init_Challenge_human_challenge
{
public:
  explicit Init_Challenge_human_challenge(::ariac_msgs::msg::Challenge & msg)
  : msg_(msg)
  {}
  ::ariac_msgs::msg::Challenge human_challenge(::ariac_msgs::msg::Challenge::_human_challenge_type arg)
  {
    msg_.human_challenge = std::move(arg);
...
public:
  ...
  : msg_(msg)
  {}
  Init_Challenge_human_challenge robot_malfunction_challenge(::ariac_msgs::msg::Challenge::_robot_malfunction_challenge_type arg)
  {
    msg_.robot_malfunction_challenge = std::move(arg);
    return Init_Challenge_human_challenge(msg_);
  }
