...
struct Challenge_
{
  ...
  using _human_challenge_type =
    ariac_msgs::msg::HumanChallenge_<ContainerAllocator>;
  _human_challenge_type human_challenge;
  ...
  Type & set__human_challenge(
    const ariac_msgs::msg::HumanChallenge_<ContainerAllocator> & _arg)
  {
    this->human_challenge = _arg;
    return *this;
  }

  // constant declarations
  static constexpr uint8_t FAULTY_PART =
    0u;
  static constexpr uint8_t DROPPED_PART =
    1u;
  static constexpr uint8_t SENSOR_BLACKOUT =
    2u;
  static constexpr uint8_t ROBOT_MALFUNCTION =
    3u;
  static constexpr uint8_t HUMAN =
    4u;
  ...
  bool operator==(const Challenge_ & other) const
  {
    ...
    if (this->human_challenge != other.human_challenge) {
      return false;
    }
    return true;
  }
...
constexpr uint8_t Challenge_<ContainerAllocator>::FAULTY_PART;
template<typename ContainerAllocator>
constexpr uint8_t Challenge_<ContainerAllocator>::DROPPED_PART;
template<typename ContainerAllocator>
constexpr uint8_t Challenge_<ContainerAllocator>::SENSOR_BLACKOUT;
template<typename ContainerAllocator>
constexpr uint8_t Challenge_<ContainerAllocator>::ROBOT_MALFUNCTION;
template<typename ContainerAllocator>
constexpr uint8_t Challenge_<ContainerAllocator>::HUMAN;
