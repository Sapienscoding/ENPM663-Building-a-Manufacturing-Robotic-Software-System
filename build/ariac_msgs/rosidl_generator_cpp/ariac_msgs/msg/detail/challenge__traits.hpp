...
#include "ariac_msgs/msg/detail/human_challenge__traits.hpp"
  ...
  std::ostream & out, size_t indentation = 0)
{
  ...
  // member: human_challenge
  {
    ...
    out << "human_challenge:\n";
    to_yaml(msg.human_challenge, out, indentation + 2);
  }
...
struct has_fixed_size<ariac_msgs::msg::Challenge>
  : std::integral_constant<bool, has_fixed_size<ariac_msgs::msg::DroppedPartChallenge>::value && has_fixed_size<ariac_msgs::msg::FaultyPartChallenge>::value && has_fixed_size<ariac_msgs::msg::HumanChallenge>::value && has_fixed_size<ariac_msgs::msg::RobotMalfunctionChallenge>::value && has_fixed_size<ariac_msgs::msg::SensorBlackoutChallenge>::value> {};

template<>
struct has_bounded_size<ariac_msgs::msg::Challenge>
  : std::integral_constant<bool, has_bounded_size<ariac_msgs::msg::DroppedPartChallenge>::value && has_bounded_size<ariac_msgs::msg::FaultyPartChallenge>::value && has_bounded_size<ariac_msgs::msg::HumanChallenge>::value && has_bounded_size<ariac_msgs::msg::RobotMalfunctionChallenge>::value && has_bounded_size<ariac_msgs::msg::SensorBlackoutChallenge>::value> {};
