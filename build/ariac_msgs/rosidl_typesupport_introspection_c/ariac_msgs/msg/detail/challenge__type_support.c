...
#include "ariac_msgs/msg/human_challenge.h"
// Member `human_challenge`
...
static rosidl_typesupport_introspection_c__MessageMember Challenge__rosidl_typesupport_introspection_c__Challenge_message_member_array[6] = {
  {
    "type",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ariac_msgs__msg__Challenge, human_challenge),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ariac_msgs, msg, Challenge)() {
  ...
  Challenge__rosidl_typesupport_introspection_c__Challenge_message_member_array[5].members_ =
