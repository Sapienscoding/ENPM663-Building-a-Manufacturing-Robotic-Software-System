...
bool ariac_msgs__msg__assembly_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ariac_msgs.msg._assembly_state.AssemblyState", full_classname_dest, 44) == 0);
  }
  ariac_msgs__msg__AssemblyState * ros_message = _ros_message;
  {  // battery_attached
...
PyObject * ariac_msgs__msg__assembly_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ariac_msgs.msg._assembly_state");
