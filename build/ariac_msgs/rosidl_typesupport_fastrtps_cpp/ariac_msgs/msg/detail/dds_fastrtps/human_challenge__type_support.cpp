...
#include "ariac_msgs/msg/detail/human_challenge__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ariac_msgs::msg::HumanChallenge & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ariac_msgs::msg::HumanChallenge & ros_message)
{
  // Member: behavior
  cdr >> ros_message.behavior;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ariac_msgs
max_serialized_size_HumanChallenge(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  auto typed_message =
    static_cast<const ariac_msgs::msg::HumanChallenge *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ariac_msgs::msg::HumanChallenge *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _HumanChallenge__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const ariac_msgs::msg::HumanChallenge *>(
...
{
  return max_serialized_size_HumanChallenge(full_bounded, 0);
}

static message_type_support_callbacks_t _HumanChallenge__callbacks = {
  "ariac_msgs::msg",
  "HumanChallenge",
...
static rosidl_message_type_support_t _HumanChallenge__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_HumanChallenge__callbacks,
...
{
  return &ariac_msgs::msg::typesupport_fastrtps_cpp::_HumanChallenge__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ariac_msgs, msg, HumanChallenge)() {
  return &ariac_msgs::msg::typesupport_fastrtps_cpp::_HumanChallenge__handle;
}
