...
class Metaclass_AGVStatus(type):
    """Metaclass of message 'AGVStatus'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__agv_status
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__agv_status
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__agv_status
            cls._TYPE_SUPPORT = module.type_support_msg__msg__agv_status
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__agv_status
    ...
    def KITTING(self):
        ...
        return Metaclass_AGVStatus.__constants['KITTING']

    @property
    def ASSEMBLY_FRONT(self):
        """Message constant 'ASSEMBLY_FRONT'."""
        return Metaclass_AGVStatus.__constants['ASSEMBLY_FRONT']

    @property
    def ASSEMBLY_BACK(self):
        """Message constant 'ASSEMBLY_BACK'."""
        return Metaclass_AGVStatus.__constants['ASSEMBLY_BACK']

    @property
    def WAREHOUSE(self):
        """Message constant 'WAREHOUSE'."""
        return Metaclass_AGVStatus.__constants['WAREHOUSE']

    @property
    def UNKNOWN(self):
        """Message constant 'UNKNOWN'."""
        return Metaclass_AGVStatus.__constants['UNKNOWN']


class AGVStatus(metaclass=Metaclass_AGVStatus):
    """
    Message class 'AGVStatus'.
