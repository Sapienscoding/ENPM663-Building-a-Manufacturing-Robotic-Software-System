...
bool ariac_msgs__msg__human_challenge__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ariac_msgs.msg._human_challenge.HumanChallenge", full_classname_dest, 46) == 0);
  }
  ariac_msgs__msg__HumanChallenge * ros_message = _ros_message;
  {  // behavior
    ...
    ros_message->behavior = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // condition
...
{
  /* NOTE(esteve): Call constructor of HumanChallenge */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ariac_msgs.msg._human_challenge");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "HumanChallenge");
