...
constexpr uint8_t AGVStatus_<ContainerAllocator>::KITTING;
template<typename ContainerAllocator>
constexpr uint8_t AGVStatus_<ContainerAllocator>::ASSEMBLY_FRONT;
template<typename ContainerAllocator>
constexpr uint8_t AGVStatus_<ContainerAllocator>::ASSEMBLY_BACK;
template<typename ContainerAllocator>
constexpr uint8_t AGVStatus_<ContainerAllocator>::WAREHOUSE;
template<typename ContainerAllocator>
constexpr uint8_t AGVStatus_<ContainerAllocator>::UNKNOWN;
